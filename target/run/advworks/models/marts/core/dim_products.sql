...
create or replace transient table azdatabase.advwork_raw.dim_products
...
subcategories as (
    ...
    from AZDATABASE.ADVWORKS.ADVENTUREWORKS_PRODUCT_SUBCATEGORIES
),
...
categories as (
    ...
    from AZDATABASE.ADVWORKS.ADVENTUREWORKS_PRODUCT_CATEGORIES
),
